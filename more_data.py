...
#print('Done')
# fetch 30 minute klines for the last month of 2017  ##start from 1 July, 2017
klines2 = client.get_historical_klines("ETHBTC", Client.KLINE_INTERVAL_15MINUTE, "1 July, 2017", "1 Jan, 2018")

# fetch weekly klines since it listed
#klines3 = client.get_historical_klines("NEOBTC", Client.KLINE_INTERVAL_1WEEK, "1 Jan, 2017")

#client.get_symbol_ticker(Client,'LTCBTC')
